...
export function Avatar(props) {
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF("models/final-avtar.glb");
  ...
  pointingAnimation[0].name = "Point";
  sittingAnimation[0].name="Sit";
  


  const { actions } = useAnimations(
    [typingAnimation[0], standingAnimation[0], fallingAnimation[0],waveAnimation[0],pointingAnimation[0],sittingAnimation[0]],
    group
  );
...
useGLTF.preload("models/final-avtar.glb");
